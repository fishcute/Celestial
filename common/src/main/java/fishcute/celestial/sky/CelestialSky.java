...
public class CelestialSky {
    ...
    public static void loadResources() {
        ...
        if (Minecraft.getInstance().player != null)
            Minecraft.getInstance().player.sendMessage(new TextComponent(ChatFormatting.GRAY + "[Celestial] Reloaded with " + warnings + " warning(s) and " +errors + " error(s)."), Util.NIL_UUID);
    }
