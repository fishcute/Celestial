...
public class Util {
    ...
    */
    ...
    static void print(double i) {
        Minecraft.getInstance().player.sendMessage(new TextComponent("Value: " + i), NIL_UUID);
    }
    ...
    public static void sendErrorInGame(String i, boolean unloadResources) {
        ...
        if (errorList.contains(i) || errorList.size() > 25)
            return;
        errorList.add(i);
        Minecraft.getInstance().player.sendMessage(new TextComponent(ChatFormatting.RED +
                "[Celestial] " + i
        ), NIL_UUID);
    ...
    public static void sendWarnInGame(String i) {
        ...
        if (errorList.contains(i))
            return;
        errorList.add(i);
        Minecraft.getInstance().player.sendMessage(new TextComponent(ChatFormatting.YELLOW +
                "[Celestial] " + i
        ), NIL_UUID);
    }
    ...
    public static Map<String, String> getReplaceMapNormal() {
        ...
        toReplaceMap.put("#xPos", Minecraft.getInstance().player.getX() + "");
        toReplaceMap.put("#yPos", Minecraft.getInstance().player.getY() + "");
        toReplaceMap.put("#zPos", Minecraft.getInstance().player.getZ() + "");
        toReplaceMap.put("#tickDelta", Minecraft.getInstance().getFrameTime() + "");
        toReplaceMap.put("#dayLight", (1.0F - Minecraft.getInstance().level.getSkyDarken(Minecraft.getInstance().getFrameTime())) + "");
        toReplaceMap.put("#rainGradient", (1.0F - Minecraft.getInstance().level.getSkyDarken(Minecraft.getInstance().getFrameTime())) + "");
        toReplaceMap.put("#isUsingSpyglass", 0 + "");
        // Spyglasses don't exist in 1.16, will return 0 for version compatibility
        toReplaceMap.put("#isSubmerged", (Minecraft.getInstance().player.isUnderWater() ? 1 : 0) + "");
        toReplaceMap.put("#getTotalTime", (Minecraft.getInstance().level.getGameTime()) + "");
    ...
    public static Map<String, String> getReplaceMapAdd(Map<String, String> extraEntries) {
        ...
        toReturn.put("#xPos", Minecraft.getInstance().player.getX() + "");
        toReturn.put("#yPos", Minecraft.getInstance().player.getY() + "");
        toReturn.put("#zPos", Minecraft.getInstance().player.getZ() + "");
        toReturn.put("#tickDelta", Minecraft.getInstance().getFrameTime() + "");
        toReturn.put("#dayLight", (1.0F - Minecraft.getInstance().level.getSkyDarken(Minecraft.getInstance().getFrameTime())) + "");
        toReturn.put("#rainGradient", (1.0F - Minecraft.getInstance().level.getSkyDarken(Minecraft.getInstance().getFrameTime())) + "");
        toReturn.put("#isUsingSpyglass", 0 + "");
        // Spyglasses don't exist in 1.16, will return 0 for version compatibility
        toReturn.put("#isSubmerged", (Minecraft.getInstance().player.isUnderWater() ? 1 : 0) + "");
        toReturn.put("#getTotalTime", (Minecraft.getInstance().level.getGameTime()) + "");
    ...
    public static ArrayList<MutablePair<MutableTriple<String, String, String>, MutablePair<String, String>>> convertToPointUvList(ArrayList<String> array) {
        ...
        //TODO: Make this better. Please -block36_
